...
<footer class="page-footer font-small text-light">
	...
	<div style="background-color: rgb(242, 101, 34);">
		<div class="container">
			...
			<div class="row py-4 d-flex align-items-center">
				...
				<div class="col-md-6 col-lg-7 text-center text-md-right">
					...
					<!--Instagram-->
					<a class="ins-ic"> <i class="fa fa-instagram white-text mr-4">
					</i>
					</a>
					<!--Linkedin -->
	...
	<div class="container text-center text-md-left mt-5">
		...
		<!-- Grid row -->
		<div class="row mt-3 unique-color-dark">
			...
			<div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
				...
				<!-- Links -->
				<h6 class="text-dark text-uppercase font-weight-bold">Products</h6>
				<hr class="accent-2 mb-4 mt-0 d-inline-block mx-auto"
					style="width: 60px;">
				<p>
			...
			<div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
				...
				<!-- Links -->
				<h6 class="text-dark text-uppercase font-weight-bold">Useful
					links</h6>
			...
			<div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
				...
				<!-- Links -->
				<h6 class="text-dark text-uppercase font-weight-bold">Contact</h6>
				<hr class="accent-2 mb-4 mt-0 d-inline-block mx-auto"
					style="width: 60px;">
				<p>
	...
	<!-- Copyright -->
	<div class="text-dark footer-copyright text-center py-3">
		© 2020 Copyright: <a href="#"> JobBazar.com</a>
	</div>
	<!-- Copyright -->
